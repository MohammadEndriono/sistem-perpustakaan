...
<head>
    ...
    <style>
    .bgg {
        background-image: url('<?php echo base_url(); ?>assets2/img/man2.jpg');
            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/q.png" width="45px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/q.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-2 z-depth-5">PERPUSTAKAAN MAN 2 SLEMAN</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/man2.jpg" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <center>Copyright by Mohammad Endri</center>
                </div>
